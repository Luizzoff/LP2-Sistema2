...
import { atualizarProduto, gravarProduto } from "../../../redux/redux.produto";
import ESTADO from "../../../redux/redux.estado";

export default function FormCadastroProduto(props) {
	const dispatch = useDispatch();
	const { estado, mensagem } = useSelector((state) => state.produtos);
	...
	useEffect(()=>{
        if(processando && estado === ESTADO.OCIOSO && mensagem && (mensagem === "Produto adicionado com sucesso!" || mensagem === "Produto atualizado com sucesso!"))
		{
    ...
    },[processando, estado, mensagem, props, produtoReseta]);
